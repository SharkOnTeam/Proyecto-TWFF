                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <form class="form-header" action="subcategoria" method="POST">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="agregar_subcategoria"> <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?=$cat['idSubcategoria'];?></td>
                                                <td><?=$cat['subcategoria'];?></td>
                                                <td>
                                                    <?php 
                                                    foreach($sub_cat as $sub){
                                                        if($cat['idSubcategoria'] == $sub['idSubcategoria']){
                                                            echo $sub['categoria'];
                                                        }
                                                    }
                                                    ?>
                                                ...
                                                <div class="table-data-feature">
                                                        <form action="agregar_subcategoria" method="POST">
                                                        <input type="hidden" value="<?=$cat['idSubcategoria'];?>" name="idSubcategoria">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Editar">
                                                            <i class="fa fa-edit"></i>
                                                        </button>
                                                        </form>
                                                        <form action="subcategoria/eliminar_subcategoria" method="POST">
                                                        <input type="hidden" value="<?=$cat['idSubcategoria'];?>" name="idSubcategoria">
