                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <form class="form-header" action="producto" method="POST">
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="agregar_producto"> <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?=$cat['idProducto'];?></td>
                                                <td><img class="img-fluid" src="<?=base_url('TWFF/vendor/uploads/').'/'.$cat['imagenProducto']?>" alt="" style="max-width: 130px;"> </td>
                                                <td><img class="img-fluid" src="<?=base_url('TWFF/vendor/uploads/').'/'.$cat['imagenProducto2']?>" alt="" style="max-width: 130px;"> </td>
                                                <td><?=$cat['producto'];?></td>
                                                <td><?=$cat['descripcionProducto'];?></td>
                                                <td>
                                                <?php 
                                                    foreach($pro_sub as $sub){
                                                        if($cat['idProducto'] == $sub['idProducto']){
                                                            echo $sub['subcategoria'];
                                                        }
                                                    }
                                                    ?>
                                                </td>
                                                <td><?=$cat['precioMenudeo'];?></td>
                                                <td><?=$cat['precioMayoreo'];?></td>
                                                <td><?=$cat['stock'];?></td>
                                                ...
                                                <div class="table-data-feature">
                                                        ...
                                                        <input type="hidden" value="<?=$cat['idProducto'];?>" name="idProducto">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Editar">
                                                            <i class="fa fa-edit"></i>
                                                        </button>
                                                        </form>
                                                        <form action="producto/eliminar_producto" method="POST">
                                                        <input type="hidden" value="<?=$cat['idProducto'];?>" name="idProducto">
                                                        <input type="hidden" value="<?=$cat['imagenProducto'];?>" name="imagenProducto">
                                                        <input type="hidden" value="<?=$cat['imagenProducto2'];?>" name="imagenProducto2">
