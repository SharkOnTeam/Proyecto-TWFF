                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <form class="form-header" action="oferta" method="POST">
                                        ...
                                        <div class="rs-select2--light rs-select2--lg">
                                        <form class="form-header" action="oferta" method="POST">
                                            <input class="au-input au-input--xl" id="buscador" type="text" name="buscador" placeholder="Buscar por descuento.." />
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <a href="agregar_oferta"> <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class="table-data-feature">
                                                        <form action="agregar_oferta" method="POST">
                                                        <input type="hidden" value="<?=$cat['idOferta'];?>" name="idOferta">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Editar">
                                                            <i class="fa fa-edit"></i>
                                                        </button>
                                                        </form>
                                                        <form action="oferta/eliminar_oferta" method="POST">
                                                        <input type="hidden" value="<?=$cat['idOferta'];?>" name="idOferta">
