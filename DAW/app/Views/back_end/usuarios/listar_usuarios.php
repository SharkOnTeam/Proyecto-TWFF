                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <form class="form-header" action="usuario" method="POST">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class="table-data-feature">
                                                        ...
                                                        <input type="hidden" value="<?=$cat['idUsuario'];?>" name="idUsuario">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Editar">
                                                            <i class="fa fa-edit"></i>
                                                        </button>
                                                        </form>
                                                        <form action="usuario/eliminar_usuario" method="POST">
                                                        <input type="hidden" value="<?=$cat['idUsuario'];?>" name="idUsuario">
