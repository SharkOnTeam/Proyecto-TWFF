                    ...
                    <div class="checkout_details_area mt-50 clearfix">
                        ...
                        <div class="cart-page-heading mb-30">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <p class="cali" id="radio">
                                    <?php switch($comen['calificacion']){ 
                                        case 1: ?>
                                        
                                            <input id="radio1" type="radio" name="estrellas" disabled>
                                            <label for="radio1">★</label>
                                            <input id="radio2" type="radio" name="estrellas" disabled>
                                            <label for="radio2">★</label>
                                            <input id="radio3" type="radio" name="estrellas" disabled>
                                            <label for="radio3">★</label>
                                            <input id="radio4" type="radio" name="estrellas" disabled>
                                            <label for="radio4">★</label>
                                            <input id="radio5" type="radio" name="estrellas" disabled checked>
                                        ...
                                        case 2: ?>
                                            ...
                                            <input id="radio3" type="radio" name="estrellas" disabled>
                                            <label for="radio3">★</label>
                                            <input id="radio4" type="radio" name="estrellas" disabled checked>
                                            <label for="radio4">★</label>
                                            <input id="radio5" type="radio" name="estrellas" disabled>
                                            <label for="radio5">★</label>
                                        ...
                                        case 3: ?>
                                            ...
                                            <input id="radio2" type="radio" name="estrellas" disabled>
                                            <label for="radio2">★</label>
                                            <input id="radio3" type="radio" name="estrellas" disabled checked>
                                            <label for="radio3">★</label>
                                            <input id="radio4" type="radio" name="estrellas" disabled>
                                            <label for="radio4">★</label>
                                            <input id="radio5" type="radio" name="estrellas" disabled>
                                        ...
                                        case 4: ?>
                                            <input id="radio1" type="radio" name="estrellas" disabled>
                                            <label for="radio1">★</label>
                                            <input id="radio2" type="radio" name="estrellas" disabled checked>
                                            <label for="radio2">★</label>
                                            <input id="radio3" type="radio" name="estrellas" disabled>
                                            <label for="radio3">★</label>
                                            <input id="radio4" type="radio" name="estrellas" disabled>
                                        ...
                                        <?php break;
                                        case 5: ?>
                                            <input id="radio1" type="radio" name="estrellas" disabled checked>
                                            <label for="radio1">★</label>
                                            <input id="radio2" type="radio" name="estrellas" disabled>
                                            <label for="radio2">★</label>
                                            <input id="radio3" type="radio" name="estrellas" disabled>
                                    ...
                                    <p><?=$comen['usuario_idUsuario'];?> | <?=$comen['fechaComentario'];?></p>
