                            ...
                            <li><a href="#">Tienda</a>
                                <div class="megamenu">
                                    <ul class="single-mega cn-col-4">
                                        <li class="title"><a href="tienda">Tradicionales</a></li>
                                        <li><a href="tienda">Tradiccional 5 picos</a></li>
                                        <li><a href="tienda">Tradiccional 7 picos</a></li>
                                    </ul>
                                    <ul class="single-mega cn-col-4">
                                        <li class="title"><a href="tienda">Animadas</a></li>
                                        <li><a href="tienda">Marvel</a></li>
                                        <li><a href="tienda">Disney</a></li>
                                        <li><a href="tienda">Pixar</a></li>
                                        <li><a href="tienda">Universal Studios</a></li>
                                    </ul>
                                    <ul class="single-mega cn-col-4">
                                        <li class="title"><a href="tienda">Especiales</a></li>
                                        <li><a href="tienda">Eventos</a></li>
                                        <li><a href="tienda">Otras</a></li>
                                        <li><a href="tienda">Personalizada</a></li>
                                    </ul>
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="<?= base_url('TWFF/vendor/template/front_end/img/product-img/producto-1.png')?>" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
